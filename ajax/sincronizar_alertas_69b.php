...
try {
    ...
    exigir_permiso_accion($pdo,(int)($_SESSION['id_usuario']??0),(int)($_SESSION['id_empresa']??0),'consulta_alertas_69b');
    ...
    $r = sat69b_cruzar_emisores($pdo, $jobId, $idEmpresa);
    echo json_encode([
        'success'=>true,
        'cancelled'=>false,
        'resumen'=>$r,
        'msg'=>'Cruce 69-B contra emisores terminado.'
    ...
    seguridad_log_error($e, 'sincronizar_alertas_69b');
    http_response_code(500);
    echo json_encode([
        'success'=>false,
        'error'=>'No se pudo realizar el cruce 69-B: '.$e->getMessage()
    ], JSON_UNESCAPED_UNICODE);
}
