...
try {
    ...
    echo json_encode([
        'data'=>$salida,
        'meta'=>[
            'origen'=>'detalles_pago_fecha_fiscal_acumulado_emisor',
    ...
    seguridad_log_error($e, 'listar_diot'); echo json_encode(['data'=>[], 'error'=>'No se pudo consultar la información DIOT.'], JSON_UNESCAPED_UNICODE|JSON_INVALID_UTF8_SUBSTITUTE);
}
