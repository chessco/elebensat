...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="assets/img/favicon.png?v=<?= filemtime(__DIR__ . '/assets/img/favicon.png') ?>">
    <link rel="icon" type="image/png" href="assets/img/pitayacode-icon.png?v=<?= filemtime(__DIR__ . '/assets/img/pitayacode-icon.png') ?>">
    <link rel="shortcut icon" href="favicon.ico?v=<?= filemtime(__DIR__ . '/favicon.ico') ?>">
    <link rel="apple-touch-icon" href="assets/img/pitayacode-icon.png?v=<?= filemtime(__DIR__ . '/assets/img/pitayacode-icon.png') ?>">
